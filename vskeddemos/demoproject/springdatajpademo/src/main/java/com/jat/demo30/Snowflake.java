...
public class Snowflake implements IdentifierGenerator {
	...
	/**
	 * reference material of 'time stamp' is '2020-12-01'. its value can't be
	 * modified after initialization.
	 */
	private final long epoch = 1606752000000L;
	...
	/**
	 * 构造方法设置机器码：第datacenterId个机房的第workerId台机器 <br>
	 *     可表达8个机房,可表达128台机器,也就是两数(datacenterId*workerId)相乘小于1024即可
	 * @param datacenterId
