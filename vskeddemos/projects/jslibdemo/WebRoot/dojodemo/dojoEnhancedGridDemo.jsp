...
<html>
  ...
  <base href="<%=basePath%>">
    ...
    <link rel="stylesheet" href="<%=basePath%>js/dojo193/dojox/grid/enhanced/resources/claroEnhancedGrid.css" media="screen">
    ...
    <script type="text/javascript" src="<%=basePath%>js/mydemojs/dojodemo/dojoEnhancedGridDemo.js"></script>
