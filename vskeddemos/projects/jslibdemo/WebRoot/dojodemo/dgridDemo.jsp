...
<html>
  ...
  <base href="<%=basePath%>">
    ...
    <link rel="stylesheet" href="<%=basePath%>js/dojo193/dgrid/css/dgrid.css" media="screen">
    ...
    <script type="text/javascript" src="<%=basePath%>js/mydemojs/dojodemo/dgridDemo.js"></script>
