/*
 ...
 Source Schema         : userrestddd

 Target Server Type    : MySQL
 Target Server Version : 50732
 File Encoding         : 65001

 Date: 25/02/2023 14:30:10
*/
...
CREATE TABLE `account`  (
  ...
  `isDel` int(1) NULL DEFAULT 0 COMMENT '0表示有效  1表示无效',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '账号表' ROW_FORMAT = Dynamic;
...
-- ----------------------------
-- Table structure for dynamicRoute
-- ----------------------------
DROP TABLE IF EXISTS `dynamicRoute`;
CREATE TABLE `dynamicRoute`  (
  ...
  `reqType` int(11) NULL DEFAULT NULL COMMENT '请求类型(1get,2post,3head,4options,5put,6delete,7trace,8connect)',
  `javaCode` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT 'java代码',
  `version` int(255) NULL DEFAULT NULL COMMENT '版本',
  `isDel` int(11) NULL DEFAULT 0 COMMENT '0表示有效  1表示无效',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of dynamicRoute
-- ----------------------------
INSERT INTO `dynamicRoute` VALUES (1, 'test', '/mockTest', 1, '{\"key\":\"v1\"}', 1, 0);
INSERT INTO `dynamicRoute` VALUES (2, 'test1', '/mockTest/tests1', 1, '{\"key\":\"v2\"}', 1, 0);
INSERT INTO `dynamicRoute` VALUES (3, 'test2', '/mockTest/tests2', 1, '{\"key\":#{int}}', NULL, 0);
...
INSERT INTO `userRole` VALUES (3, 10, 0);
INSERT INTO `userRole` VALUES (3, 11, 0);
